...
import TobetoSuccessModel from "./pages/TobetoSuccessModela/TobetoSuccessModel";
import SuccessModel1 from "./pages/TobetoSuccessModela/SuccessModel1";
...
import AnalysisReport from "./pages/TobetoSuccessModela/AnalysisReport";
