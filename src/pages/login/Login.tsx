                ...
                <div className="py-4 px-sm-0 px-md-12 text-center">
                  <div className="d-flex flex-column align-items-center mt-4">
                    ...
                    <form className="mt-5" onSubmit={onSubmit}>
                      <input className="form-control mt-6 " placeholder="E-Posta" onChange={(e) => setEmail(e.target.value)} />
                      <input className="form-control mt-6" type="password" placeholder="Şifre" onChange={(e) => setPassword(e.target.value)} />
                      <button className="btn btn-primary w-100 mt-6" type="submit">Giriş Yap</button>
                      <label>
                        <small>
                          <p className="text-decoration-none text-muted mt-5 d-block" style={{ cursor: 'pointer' }}>
                            Şifremi Unuttum
                          </p>
                        </small>
                      </label>
                    ...
                    <div className="col-12 mt-6">
                      <label>
                        <small>
                          ...
                          <a className="text-decoration-none text-muted fw-bold" href="/register">
                            {' '}
                            Kayıt Ol
                          </a>
                        </small>
