        ...
        <div className="row align-items-center">
          <div className="col-12 col-lg-6 mt-32 order-last order-lg-first">
            <div className="mw-md mx-auto pt-20 pb-24 px-8 px-md-12 px-xl-14 rounded bg-light" style={{boxShadow: '8px 80px 138px rgba(0, 0, 0, 0.11)'}}>
              ...
              <a className="btn btn-primary w-100" href="/bilgi-al"> Eğitim tarihlerinden haberdar olmak için</a>
            </div>
          </div>
          <div className="col-12 col-lg-6 mt-8">
            <div className="mw-lg text-center mx-auto">
              ...
              <Link className="btn btn-primary " to="/register">Ücretsiz Üye Ol</Link>
            </div>
          </div>
        </div>
        ...
        <div className="row">
          ...
          <div className="col-12 col-lg-6 pe-lg-4 mb-8">
            <div className="b-r-15 p-8 bg-info">
              ...
              <ul className="text-white m-0 p-0">
                <li className="list-unstyled">
                  • Baştan sona veri yapısı, ekran görünümleri, servis ihtiyaçları ve versiyon kontrolü
                  ile bütün bir proje geliştirme
                </li>
                <li className="list-unstyled">
                  <br />
                </li>
    ...
    <section className="py-10">
      <div className="container">
        <div>
          ...
          <p className="text-white">
            Üniversite öğrencileri, profesyoneller, işini veya mesleğini değiştirmek ya da işinde gelişmek
            isteyen herkes katılabilir. ​
          </p>
          <p className="text-white">
            Dünya çapında popülerliği ve iş olanakları artan yazılım geliştirme alanında kendini geliştirmek
